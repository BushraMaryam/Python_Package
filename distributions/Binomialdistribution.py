...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        #self.calculate mean and stdev are menioned in distribution.init so that beth functions can get access of attributes of distribution   
    ...
    def plot_bar_pdf(self):
        ...
        for i in range(self.n+1):
            ...
            y.append(self.pdf(i))
        plt.bar(x,y)
        plt.label("Distribution of Outcomes")
    ...
    def __repr__(self):
        ...
        return f"mean: {self.mean},standard deviation:{self.stdev}, probability: {self.p}, size:{self.n}  " 
        pass
